...
<html>
	...
	<body>
		<div class="nav" id="nav">
					<nav>
						<a class="logo" href="#"><h3><img src="src/img/音乐 (1).png" /><b>欣欣音乐</b></h3></a>
						<ul class="clearfix">
...
<!-- 内容 -->
							...
							<blockquote>
							人潮拥挤我能感觉你。
							 <small>我们都需要勇气 <cite title="Source Title">去相信会在一起</cite></small>
							</blockquote>
							</div>
							<div class="col-sm-6 col-md-3">
								<a href="#" class="thumbnail">
							...
							<blockquote>
							你拉着我说你有些犹豫。
							 <small>印象中的 <cite title="Source Title">爱情好像抵不住那时间</cite></small>
							</blockquote>
							</div>
							<div class="col-sm-6 col-md-3">
								<a href="#" class="thumbnail">
							...
							<blockquote>
							如果我的坚强任性
							 <small>成全了你的 <cite title="Source Title">碧海蓝天</cite></small>
							</blockquote>
							</div>
							<div class="col-sm-6 col-md-3">
								<a href="#" class="thumbnail">
