...
<html>
	<head>
		<meta charset="utf-8" />
		<title>音乐--和谐现场</title>
		<link rel="stylesheet" type="text/css" href="/gitpp/Public/css/main.css"/>
	</head>
	<body>
		<div class="main">
			<div class="tou">
			...
			<div class="zhong">
				...
				<table id="zhong2" bordercolor="darkgray" border="1" frame="void" cellspacing="20px" cellpadding="0px" align="center" style="margin-top: 30px;">
							<tr>
								<th><img src="/gitpp/Public/img/team1.jpg" width="280" height="280">
									<div style="color: dimgray;">
										Elizabeth
									</div>
								</th>
								<th>
									<img src="/gitpp/Public/img/team2.jpg" width="280" height="280">
									<div style="color: dimgray;">
										Max Payne
									</div>
								</th>
								<th>
									<img src="/gitpp/Public/img/team3.jpg" width="280" height="280">
									<div style="color: dimgray;">
										Diana
									</div>
								</th>
								<th>					
									<img src="/gitpp/Public/img/team4.jpg" width="280" height="280" >
									<div style="color: dimgray;">
										Johnny Blaz
									</div>
								</th>
