...
<div class="col-lg-12">
	<table class="table">
	  ...
	  <tbody>
	  	<?php
 foreach($loop as $value){ $i = $value["id"]; echo "<tr><td>$value[descrip]</td><td>$value[src]</td><td>
				<button class='loopbuton' data-id = '$value[id]' data-toggle='modal' data-target='#myModal'>修改图片</button></td></tr>"; } ?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" action="/gitPhp/index.php/Admin/Index/modification" enctype="multipart/form-data">
